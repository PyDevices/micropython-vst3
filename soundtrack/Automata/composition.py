...
TRACKS = [
    {"name": "Kick", "script": "tr909.py", "gain_db": -5.0, "pan": 0.0,
     "notes": kick_notes(),
     "macros": {},
     "vol": [(M1, 0.85), (M2, 1.0), (M5, 0.9)],
     "macro_env": {}},
    {"name": "Snare", "script": "tr909.py", "gain_db": -3.0, "pan": 0.02,
     "notes": snare_notes(),
     "macros": {},
     "vol": [(M2, 0.9), (M3, 1.0), (M4, 1.05)],
     "macro_env": {}},
    {"name": "Hats", "script": "tr909.py", "gain_db": -8.5, "pan": 0.12,
     "notes": hats_notes(),
     "macros": {},
     "vol": [(M2, 0.85), (M3, 1.0)],
     "macro_env": {}},
    {"name": "Claps", "script": "tr909.py", "gain_db": -7.0, "pan": -0.06,
     "notes": claps_notes(),
     "macros": {},
     "vol": [(M3, 0.9), (M4, 1.0)],
     "macro_env": {}},
    {"name": "Toms", "script": "tr909.py", "gain_db": -7.0, "pan": 0.0,
     "notes": toms_notes(),
     "macros": {},
     "vol": [(M2, 1.0)],
     "macro_env": {}},
    {"name": "Shaker", "script": "tr808.py", "gain_db": -11.0, "pan": -0.2,
     "notes": shaker_notes(),
     "macros": {},
     "vol": [(M2, 1.0)],
     "macro_env": {}},
    {"name": "Glitch", "script": "sp1200.py", "gain_db": -13.0, "pan": 0.15,
     "notes": glitch_notes(),
     "macros": {},
     "vol": [(M2, 1.0)],
     "macro_env": {}},
    {"name": "Impact", "script": "simmons_sdsv.py", "gain_db": -6.5, "pan": 0.0,
     "notes": impact_notes(),
     "macros": {},
     "vol": [(M2, 0.8), (M3, 0.95), (M4, 1.0), (M5, 0.7)],
     "macro_env": {}},
    {"name": "Acid", "script": "tb303.py", "gain_db": -8.5, "pan": 0.0,
     "notes": acid_notes(),
     "macros": {},
     "vol": [(M3, 0.9), (M4, 1.0), (b4(41), 1.05)],
     "macro_env": {}},
    {"name": "Sub Bass", "script": "taurus.py", "gain_db": -6.5,
     "pan": 0.0, "notes": sub_bass_notes(),
     "macros": {},
     "vol": [(M1, 0.9), (M3, 1.0), (M5, 0.85)],
     "macro_env": {}},
    {"name": "Reese", "script": "virus.py", "gain_db": -10.5, "pan": 0.0,
     "notes": reese_notes(),
     "macros": {},
     "vol": [(M2, 0.95)],
     "macro_env": {}},
    {"name": "Supersaw", "script": "jp8000.py", "gain_db": -1.0,
     "pan": 0.0, "notes": supersaw_notes(),
     "macros": {},
     "vol": [(M4, 0.95), (b4(25), 1.05), (b4(40, 4.0), 1.0)],
     "macro_env": {}},
    {"name": "Pump Pad", "script": "juno106.py", "gain_db": -8.0,
     "pan": 0.0, "notes": pump_pad_notes(),
     "macros": {},
     "vol": [(M3, 0.85), (b3(17), 1.0), (M4, 1.0), (b4(40, 4.0), 0.9)],
     "macro_env": {}},
    {"name": "Polyseq", "script": "polysix.py", "gain_db": -6.0,
     "pan": 0.0, "notes": polyseq_notes(),
     "macros": {},
     "vol": [(M2, 0.9), (b2(17), 1.0), (b2(32, 3.5), 0.95)],
     "macro_env": {}},
    {"name": "Arp", "script": "sh101.py", "gain_db": -10.0, "pan": -0.1,
     "notes": arp_fast_notes(),
     "macros": {},
     "vol": [(M3, 0.85), (M4, 1.0)],
     "macro_env": {}},
    {"name": "FM Bells", "script": "dx7.py", "gain_db": -9.5,
     "pan": 0.2, "notes": fm_bells_notes(),
     "macros": {},
     "vol": [(M1, 0.95), (M2, 0.85), (M5, 1.0)],
     "macro_env": {}},
    {"name": "Keys", "script": "rhodes.py", "gain_db": -7.5, "pan": -0.05,
     "notes": keys_notes(),
     "macros": {},
     "vol": [(M5, 1.0), (b5(13), 0.95), (b5(16, 4.0), 0.7)],
     "macro_env": {}},
    {"name": "Organ", "script": "b3.py", "gain_db": -10.5, "pan": 0.05,
     "notes": organ_notes(),
     "macros": {},
     "vol": [(M4, 0.9), (b4(25), 1.0)],
     "macro_env": {}},
    {"name": "Brass", "script": "jupiter8.py", "gain_db": -7.5,
     "pan": 0.18, "notes": brass_stabs_notes(),
     "macros": {},
     "vol": [(M4, 0.95), (b4(25), 1.05)],
     "macro_env": {}},
    {"name": "Strings", "script": "solina.py", "gain_db": -6.5,
     "pan": -0.15, "notes": strings_notes(),
     "macros": {},
     "vol": [(M2, 0.85), (M3, 0.9), (b4(25), 1.0), (M5, 0.8)],
     "macro_env": {}},
    {"name": "Choir", "script": "vp330.py", "gain_db": -7.0, "pan": 0.0,
     "notes": choir_notes(),
     "macros": {},
     "vol": [(M1, 0.9), (M5, 1.0), (b5(16, 4.0), 0.75)],
     "macro_env": {}},
    {"name": "Glass", "script": "ppg_wave.py", "gain_db": -12.0, "pan": 0.1,
     "notes": glass_notes(),
     "macros": {},
     "vol": [(M1, 0.9), (M5, 1.0)],
     "macro_env": {}},
    {"name": "Riser", "script": "microwave.py", "gain_db": -10.0, "pan": 0.0,
     "notes": riser_notes(),
     "macros": {},
     "vol": [(M1, 0.8), (M3, 1.0), (b5(13), 0.9)],
     "macro_env": {}},
    {"name": "Texture", "script": "prophet_vs.py", "gain_db": -17.0,
