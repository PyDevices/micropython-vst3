...
"""Brass stabs: bright saw pair with a very fast filter bloom and a tight
room, tuned for short rhythmic hits. Macro 1 is brightness, macro 2
the room.
"""
...
def create(sample_rate, transport=None):
    ...
    verb = audiofreeverb.Freeverb(roomsize=0.82, damp=0.4, mix=0.22,
                                  ...
                                  buffer_size=2048)
    brightness = 3200.0
    env = synthio.Envelope(attack_time=0.02, decay_time=0.12, release_time=0.22,
    ...
    def handle_event(event_type, channel, note_id, data0, value0, value1,
        ...
        if event_type == EVENT_NOTE_ON and value0 > 0.0:
            ...
            amp = 0.16 + 0.3 * value0
            opener = synthio.LFO(waveform=RISE, once=True, rate=1.0 / 0.09,
